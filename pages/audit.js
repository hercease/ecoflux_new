	...
	<div  className="container">
		<div className="row align-items-center vh-75">
			<div className="col-md-6 col-xl-7">
				<h2 className="fw-bold">Energy Audit</h2>
				<p className="py-2">Energy assessment should be the first step before adding a renewable energy system to your home or office. An energy assessment, also known as energy audit, can help you understand your energy use by quantifying your home or office energy usage.</p>
				<p>With our energy assessment, you can determine your energy needs and make an informed decision on the best solar power components to meet your energy needs. .</p>
				
			</div>
			<div className="col-md-5 col-xl-5 py-3 text-center">
				<img className="img-fluid w-100" style={{ borderRadius: "50px 50px 50px 50px" }} src="https://picsum.photos/300/150" />
			</div>
		</div>
	 </div>
		<br />
